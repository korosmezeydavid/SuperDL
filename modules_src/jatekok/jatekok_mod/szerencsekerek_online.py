...
_SUGO = (
    ...
    "• Írd be a NEVED.\n"
    "• Ha TE szervezed: „Új szoba” → kapsz egy KÓDOT. „Kód másolása” (a "
    "vágólapra kerül), és küldd el a többieknek üzenetben, vagy mondd be. Amikor "
    "mind bent vannak: „Játék indítása”.\n"
    "• Ha CSATLAKOZOL: írd a kód mezőbe a kapott KÓDOT, majd „Csatlakozás”, és "
    "várd, hogy a szervező elindítsa.\n\n"
    "CSEVEGÉS (ÚJ)\n"
    "Az ablak alján a „Csevegés a játékosokkal” mezőbe írhattok egymásnak – "
