...
# A magyar kódlap-felismerés (CP1250/CP852/CWI-2 + kettős kódolás) a KÖZÖS
# Core-modulba költözött, hogy a könyvolvasó és a hangoskönyv-készítő is
# UGYANAZT használja – korábban ugyanaz a fájl máshogy nyílt meg.
# [Herman Tibi TEXT-P0-01]
from superdl import textdecode as _td

_TRY_ENC = _td.TRY_ENC
_HU_CHARS = _td.HU_CHARS
_OK_EXTRA = _td.OK_EXTRA
_CWI2_TABLE = _td._CWI2_TABLE
_CP1250_REV = _td._CP1250_REV
decode_cwi2 = _td.decode_cwi2
read_cwi = _td.read_cwi
_has_c1_controls = _td.has_c1_controls
_undouble_cwi = _td.undouble_cwi
_decode_score = _td.decode_score
_auto_decode = _td.auto_decode
